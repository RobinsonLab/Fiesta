        ...
        case 3
            if isempty(Data.vel{nObject})
                ...
                if get(hVelocityStatsGui.mData,'Value')==1
                    ...
                    if get(hVelocityStatsGui.mSmooth,'Value')==1 || isempty(hVelocityStatsGui.SmoothBox)
                        plot(hVelocityStatsGui.aPlot,Objects(nObject).Results(:,2),Objects(nObject).PathData(:,3)/Units.val,'b-');
                    else
                        plot(hVelocityStatsGui.aPlot,Objects(nObject).Results(:,2),smooth(Objects(nObject).PathData(:,3),hVelocityStatsGui.SmoothBox)/Units.val,'b-');
                    end
                end
