...
r=sort(get(hConfigGui.pGeneral.pFilter,'Children'));
...
if get(r(4),'Value')==1
    tempConfig.Threshold.Filter = [tempConfig.Threshold.Filter '+background_' num2str(round(mean(hMainGui.Values.MeanStack) + hMainGui.Values.PixMin))];
end
