...
hMenu.mProjDriftCorrect = uimenu('Parent',hMenu.mView,'Callback','fMenuView(''DriftCorrect'',getappdata(0,''hMainGui''));','Enable','off',...
                            'Label','Drift correction of projections','Tag','mProjDriftCorrect','Separator','on','Checked', 'off');        
                    
hMenu.mRedGreenOverlay = uimenu('Parent',hMenu.mView,'Callback','fMenuView(''RedGreenOverlay'');','Enable','off',...
                                'Label','Red-Green-Overlay','Tag','mRedGreenOverlay','Separator','on');
